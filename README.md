...
تطبيق عربي للأفلام والمسلسلات بواجهة سينمائية مخصصة للهاتف. يعمل كتطبيق ويب تقدّمي قابل للتثبيت (PWA)، ويأتي معه مشروع Android يبني ملف APK تلقائيًا عبر GitHub Actions. الإصدار الحالي **2.0.0 — نسخة المستخدم**.
...
4. أضف المحتوى المنشور داخل Collection باسم `content`.
...
للمحتوى الحي أضف المستند إلى Collection باسم `content` في Firestore. ويمكن إبقاء نسخة احتياطية داخل `web/data.js`:
